...
> Action: Complete the Active Directory guide. [Click here for the Active Directory Setup Guide](../3-ad-setup/)
...
> Action: Complete the LDAP guide. [Click here for the LDAP Authentication Setup Guide](../3-ldap-setup/)
